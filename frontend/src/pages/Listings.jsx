            ...
            {filteredListings.slice(0, 10).map((listing) => {
              ...
              <Grid item xs={12} sm={6} md={6}>
                <Card key={listing.id} className={classes.cardStyle}>
                  ...
                  <CardHeader
                    ...
                    title={
                      <Box display="flex" justifyContent="space-between" alignItems="center">
                        <Typography variant="h6" style={{ fontSize: "18px", lineHeight: "1"}}>
                          {listing.title.substring(0, 32)}
                        </Typography>
                        <IconButton
                          aria-label="settings"
                          onClick={() =>
                  ...
                  />
                  <CardContent>
                    <Typography gutterBottom variant="body4" component="div" style={{ height:'1rem',fontSize: "11px" }}>
